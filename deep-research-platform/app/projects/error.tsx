  ...
  return (
    <main className="flex min-h-screen items-center justify-center p-8">
      <GlassCard className="w-full max-w-md p-8 text-center">
        ...
        <h2 className="mb-2 text-lg font-semibold text-white">Projects error</h2>
        <p className="mb-6 text-sm text-ds-muted">{error.message || "Something went wrong loading your projects."}</p>
